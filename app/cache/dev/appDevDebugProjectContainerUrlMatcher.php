    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/project')) {
            ...
            if (preg_match('#^/project/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'project_show')), array (  '_controller' => 'AppBundle\\Controller\\ProjectController::showAction',));
            }
            not_project_show:
            ...
            if (preg_match('#^/project/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'project_edit')), array (  '_controller' => 'AppBundle\\Controller\\ProjectController::editAction',));
            }
            not_project_edit:
            ...
            if (preg_match('#^/project/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'project_delete')), array (  '_controller' => 'AppBundle\\Controller\\ProjectController::deleteAction',));
            }
            not_project_delete:

        }

        if (0 === strpos($pathinfo, '/soustache')) {
            // soustache_index
            if (rtrim($pathinfo, '/') === '/soustache') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_soustache_index;
                }

                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'soustache_index');
                }

                return array (  '_controller' => 'AppBundle\\Controller\\SousTacheController::indexAction',  '_route' => 'soustache_index',);
            }
            not_soustache_index:

            // soustache_new
            if ($pathinfo === '/soustache/new') {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_soustache_new;
                }

                return array (  '_controller' => 'AppBundle\\Controller\\SousTacheController::newAction',  '_route' => 'soustache_new',);
            }
            not_soustache_new:

            // soustache_show
            if (preg_match('#^/soustache/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_soustache_show;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'soustache_show')), array (  '_controller' => 'AppBundle\\Controller\\SousTacheController::showAction',));
            }
            not_soustache_show:

            // soustache_edit
            if (preg_match('#^/soustache/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_soustache_edit;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'soustache_edit')), array (  '_controller' => 'AppBundle\\Controller\\SousTacheController::editAction',));
            }
            not_soustache_edit:
            ...
            if (preg_match('#^/soustache/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_soustache_delete;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'soustache_delete')), array (  '_controller' => 'AppBundle\\Controller\\SousTacheController::deleteAction',));
            }
            not_soustache_delete:
        ...
        if (0 === strpos($pathinfo, '/tache')) {
            ...
            if (rtrim($pathinfo, '/') === '/tache') {
                ...
                return array (  '_controller' => 'AppBundle\\Controller\\TacheController::indexAction',  '_route' => 'tache_index',);
            }
            not_tache_index:
            ...
            if ($pathinfo === '/tache/new') {
                ...
                return array (  '_controller' => 'AppBundle\\Controller\\TacheController::newAction',  '_route' => 'tache_new',);
            }
            not_tache_new:
            ...
            if (preg_match('#^/tache/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'tache_show')), array (  '_controller' => 'AppBundle\\Controller\\TacheController::showAction',));
            }
            not_tache_show:
            ...
            if (preg_match('#^/tache/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'tache_edit')), array (  '_controller' => 'AppBundle\\Controller\\TacheController::editAction',));
            }
            not_tache_edit:
            ...
            if (preg_match('#^/tache/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'tache_delete')), array (  '_controller' => 'AppBundle\\Controller\\TacheController::deleteAction',));
            }
            not_tache_delete:
